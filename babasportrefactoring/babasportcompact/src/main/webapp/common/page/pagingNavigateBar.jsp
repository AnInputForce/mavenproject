...
<div id="pageNavBar" class="printaction">
  <ul>
    ...
    <s:iterator  begin="pageview.pageindex.startpage" end="pageview.pageindex.endpage" var="wp">
      <s:url id="pageurl" action="list_list" namespace="/control/product/type">
        <s:param name="page" value="#wp"/>
        <s:param name="query" value="%{query}"/>
        <s:param name="productType.name" value="%{productType.name}"/>
      </s:url>
      <li>
