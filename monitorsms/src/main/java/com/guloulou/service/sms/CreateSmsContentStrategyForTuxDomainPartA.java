 ...
 * @author Kang.Cunhua
 */
public class CreateSmsContentStrategyForTuxDomainPartA extends CreateSmsContentStrategyAbst {

  public String editSmsContent() {
    System.out.println("调用策略类：" + "CreateSmsContentStrategyForTuxDomainPartA!");
    ...
    String sql = "select h.hostDesc, t.ldomain,t.rdomain,t.dmstate,t.updatetime, t.alertflag,t.alertcontent "
            ...
            + "and t.alertflag=? group by t.rdomain";
    ...
    if (resultlist.size() > 0) {
      for (int i = 0; i < resultlist.size(); i++) {
        ...
        appendtmp.append(tmprdomin).append("、");

      }

      String tempstr = appendtmp.toString();
      tempstr = tempstr.substring(0, tempstr.lastIndexOf("、"));
      returntmp = updateTemplate(new TuxDomainStatus(tempstr), properties.getProperty("tuxDomainForPartA"));
